...
namespace yoshuwa.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(string.Format("yoshuwa.controllers.{0}.xml", controller), string.Format("yoshuwa.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(yoshuwa.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("yoshuwa.Reports.{0}", name), string.Format("yoshuwa.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = yoshuwa.Data.Controller.CreateConfigurationInstance(t, controller);
